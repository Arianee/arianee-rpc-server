...
const arianeeRPCServer_1 = require("../arianeeRPCServer");
const axios = require("axios");
const arianeeRpcServer = new arianeeRPCServer_1.ArianeeRPCCustom()
    .setFetchCertificateContent(() => {
    return axios("https://jsonplaceholder.typicode.com/todos/1").then(response => response.data);
})
    // with simple Promise
...
//# sourceMappingURL=aaa-main-instanciation.js.map